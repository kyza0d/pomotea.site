...
export const Logo = ({ className = "", size = 28, showText = true }: LogoProps) => {
  return (
    <div className={`flex items-center cursor-pointer ${className}`}>
      <svg width={size} height={size} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={showText ? "bg-landing-borders/50 border-2 border-landing-borders/60 rounded-md mr-3" : ""}>
